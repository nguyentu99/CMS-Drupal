  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 mb-5 ftco-animate">
        <a href="images/prod-1.jpg" class="image-popup prod-img-bg"><img src="<?php if(!empty($variables['product']->field_product_image['und']['0']['uri'])){
            print (file_create_url($variables['product']->field_product_image['und']['0']['uri']));
          }?>" class="img-fluid" alt="Colorlib Template"></a>
      </div>
      <div class="col-lg-6 product-details pl-md-5 ftco-animate">
        <h3><?php if(!empty($variables['product']->title)){
          print_r($variables['product']->title);
        }?></h3>
        ...
        <p class="price"><span><?php if(!empty($variables['product']->field_product_prime['und']['0']['value'])){
          print('$'.$variables['product']->field_product_prime['und']['0']['value']);
          }else{print ('Chưa có giá');}?></span></p>
        <p><?php if(!empty($variables['product']->body['und']['0']['value'])){
          print ($variables['product']->body['und']['0']['value']);
          }?>
        </p>
        <div class="row mt-4">
